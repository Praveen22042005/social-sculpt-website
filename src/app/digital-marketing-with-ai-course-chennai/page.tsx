...
//             <section className="banner-positioning digital-marketing">
//                 <div className="container">
//                     <div className='row'>
//                         <div className='col-lg-6'>
//                             <div className='academic-banner-left'>
//                                 <h1>You're Not a Student. You're a Brand in the Making.
//                                 </h1>
//                                 <p className='mt-4'>It's provocative, memorable, speaks directly to ambition, and positions the course as insider knowledge - exactly what a premium academy should feel like.</p>

//                                 <button className='academic-banner-btn'>
...
//             <section className="ds-highlight-section">
//                 <div className="container">
//                     <div className="row">

//                         <div className="col-lg-5 ds-left-side">
//                             <div className="ds-left-inner">
...
//                                     Why Social Sculpt is the Right Choice for You?
//                                 </h2>

//                                 <p className="ds-description mt-3">
//                                     We are Chennai's #1 agency-style digital marketing institute offering
//                                     100% placement support, 20+ certifications, and real brand exposure.
//                                 </p>

//                                 <div className="wrapper">
//                                     <a href="#" className='black mt-5'><span>Start Sculpting</span></a>
//                                 </div>

//                             </div>
//                         </div>

//                         <div className="col-lg-7 ds-right-side">
//                             <div className="ds-feature">
//                                 <h4>1. Only Agency-Styled Digital Marketing Course in India</h4>
//                                 <p>Train in a real-time, agency-based environment and learn how to operate like a 5 in 1 marketer using AI.</p>
//                             </div>

//                             <div className="ds-feature">
//                                 <h4>2. Dual Certification: Digital Marketing + AI Marketing</h4>
//                                 <p>The only course offering both full-stack digital marketing and AI marketing certification.</p>
//                             </div>

//                             <div className="ds-feature">
//                                 <h4>3. Job-Ready in Just 4 Months</h4>
//                                 <p>16 weeks of practical training, live brand projects, resume building and placement assistance.</p>
//                             </div>

//                             <div className="ds-feature">
//                                 <h4>4. Live + Bonus Pre-Recorded Modules</h4>
//                                 <p>Weekday live sessions + access to recorded lessons and high-impact bonus modules.</p>
//                             </div>

//                             <div className="ds-feature">
//                                 <h4>5. Freelancer & Sales Accelerator Program</h4>
//                                 <p>4-week live training on how to pitch, price and close freelance clients.</p>
//                             </div>
...
//                 <div className='container'>
//                     <h2 className='common-heading text-center'>Master Digital Marketing<br className='break-tag' /> with Placement Guidance</h2>
//                     <p className='text-center mt-3'>Social Sculpt Zen Class Learners will enjoy the 360-degree career & Placement Guidance.<br className='break-tag' /> Enroll now & secure your dream job in Digital Marketing.  </p>

//                     <div className='master-steps-image'>
//                         <img src="/digital.svg" alt="Digital Marketing" className="img-fluid" />
//                     </div>

//                     <div className='d-flex justify-content-center mt-lg-5'>
//                         <div className="wrapper mt-4 mb-3">
//                             <a href="/" className="black"><span>Start Learning</span></a>
//                         </div>
//                     </div>
//                 </div>
//             </section>
...
//                     <h2 className='common-heading text-center'>Career Outcomes & Success Stories</h2>
//                     <p className='text-center mt-3'>Social Sculpt Zen Class Learners will enjoy the 360-degree career & Placement Guidance.<br className='break-tag' /> Enroll now & secure your dream job in Digital Marketing.  </p>

//                     <div className='mt-5'>
//                         <div className='row'>
//                             <div className='col-lg-4'>
//                                 <div className='real-career-card'>
//                                     <div className="image-wrap">
//                                         <img src="advisory-hme.png" alt="About Social Sculpt" className="img-fluid" />
//                                     </div>
//                                     <h3>Start Freelancing & Land Clients</h3>
//                                     <p>No experience? No problem ?</p>
//                                     <p className='mt-2'>Many of our students started freelancing while still learning — offering services in social media, content, ads, and SEO. Some even signed their first client in under 30 days.</p>
//                                     <p className='mt-2'>Many of our students started freelancing while still learning — offering services in social media, content.</p>
...
//             <section className="salary-section section-padding position-relative">
//                 <div className="container">

//                     <h2 className="salary-title">Digital Marketing Job Roles And Salary</h2>

//                     <div className="salary-wrapper">

//                         <div className="salary-side left">
...
//                             <p className="avg-text">Average Salary</p>

//                             <h3 className="salary">₹4.9 LPA</h3>

//                             <span className="brand">Ambition Box</span>

//                         </div>


//                         <div className="salary-side right">
...
//                     <div className="mb-4">
//                         <h2 className="common-heading ">
//                             Advantages of our Digital marketing Course
//                         </h2>
//                     </div>
...
//                                 desc: "We combine strategic thinking with data-driven execution to build growth systems that deliver measurable results."
//                             },
//                             {
//                                 number: "02",
//                                 title: "Sculpted Growth Plans",
//                                 desc: "Every strategy is customized to your business goals, audience behavior, and revenue targets."
//                             },
//                             {
//                                 number: "03",
//                                 title: "Optimization Mindset",
//                                 desc: "We continuously test, refine, and optimize campaigns to improve performance and maximize ROI."
//                             },
//                             {
//                                 number: "04",
//                                 title: "Results That Scale",
//                                 desc: "Our approach focuses on predictable demand, stronger pipelines, and sustainable revenue growth."
//                             }
//                         ].map((item, index) => (
//                             <div className="col-lg-6" key={index}>
//                                 <div className="why-card-services digital-marketing">
//                                     <div>
...
//             <section className='section-padding'>
//                 <div className='pb-4'>
//                     <h2 className='common-heading text-center'>Build Classy Real-World Projects</h2>
//                     <p className='text-center mt-4'>Entrepreneurs, startup founders, and business enthusiasts looking to gain industry knowledge<br className='break-tag' /> and apply it to their business ventures are welcomed to enroll.</p>
//                     <div className='mt-4'>
...
//                                 <div className='academic-page-who'>
...
//                                         <p>
//                                             Delivering modern, scalable learning solutions designed for institutions
//                                             and professionals.
//                                         </p>
//                                     </div>
//                                 </div>
...
//                             </div>
//                             <div className="wrapper ms-lg-4 ms-md-4 ms-0 mt-lg-0 mt-md-0 mt-4" data-aos="fade-down-right">
        ...
        <div className=''>
            ...
            <div className="row g-0 academy-method-pillars">
              ...
              <div className="col-12 col-md-4 academy-method-pillar">
                ...
                <div className="academy-method-pillar-line"></div>
                            ...
                            <div className="mt-5">
                                <div className="container">
                                    <div className="row">
                                        ...
                                        <div className="col-lg-4">
                                            <div className="choose-your-path-card my-lg-0 my-4" data-aos="zoom-in" data-aos-delay="200">
                                                <div className="image-wrap ">
                                                    <img src="./academic-hme.png" alt="About Social Sculpt" className="img-fluid" />
                                                </div>
                                                <div className="content-card">
                        ...
                        <div className="container">
                            ...
                            <div className="row g-3 academy-tracks-grid">
                                <div className="col-12 col-md-6">
                                    <div className="academy-tcard academy-tcard-dark h-100">
                                        ...
                                        <p className="academy-tcard-desc">Learn how to scale brands with systems, data, and performance-driven thinking.</p>
                                        <ul className="academy-tcard-skills">
                                            <li><span className="academy-tcheck"><i className="fa-solid fa-arrow-right"></i></span>Social media growth systems that compound SEO</li>
                                            <li><span className="academy-tcheck"><i className="fa-solid fa-arrow-right"></i></span>SLLM-driven discovery strategies</li>
                                ...
                                <div className="col-12 col-md-6">
                                    <div className="academy-tcard academy-tcard-light h-100 mt-lg-0 mt-4">
                                        <div className="academy-tcard-icon">🎯</div>
                                        <p className="academy-tcard-track">Track B</p>
                                        <h3 className="academy-tcard-name">Personal Branding</h3>
                                        <p className="academy-tcard-desc">Turn your skills, ideas, and perspective into a brand that attracts opportunities.</p>
                                        <ul className="academy-tcard-skills">
                                            <li><span className="academy-tcheck"><i className="fa-solid fa-arrow-right"></i></span>Personal brand positioning </li>
                                            <li><span className="academy-tcheck"><i className="fa-solid fa-arrow-right"></i></span>niche clarity LinkedIn & Instagram growth systems</li>
                                            <li><span className="academy-tcheck"><i className="fa-solid fa-arrow-right"></i></span>Content frameworks that build authority Monetization</li>
                                            <li><span className="academy-tcheck"><i className="fa-solid fa-arrow-right"></i></span>inbound opportunity systems</li>
                                        </ul>
                    ...
                    <section className='Tools-Technologies technologies-logo section-padding-bottom position-relative common-backline'>
                        <div className='container'>
                            ...
                            <div className='mt-5 digital-tech-logo'>
                                <div className='row justify-content-center'>
                                    ...
                                    <div className='col-lg-2 col-4 my-auto '>
                                        <div className='mt-lg-0 mt-5'>
                                            <img src="./technologies/google-ads.png" alt="Digital Marketing" className="img-fluid google-ads" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className='mt-5 digital-tech-logo'>
                                <div className='row justify-content-center'>
                                    ...
                                    <div className='col-lg-2 col-4 my-auto'>
                                        <div className='mt-lg-0 mt-5'>
                                            <img src="./technologies/figma.jpg" alt="Digital Marketing" className="img-fluid figma" />
                                        </div>
                                    </div>
                                    <div className='col-lg-2 col-4 my-auto'>
                                        <div className='mt-lg-0 mt-5'>
                                            <img src="./technologies/canva.jpeg" alt="Digital Marketing" className="img-fluid google-ads" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='mt-5 digital-tech-logo'>
                                <div className='row justify-content-center align-items-center'>
                                    <div className='col-lg-2 col-4 my-auto'>
                                        <div className=''>
                                            <img src="./technologies/semrush.png" alt="Digital Marketing" className="img-fluid small-image" />
                                        </div>
                                    </div>
                                    <div className='col-lg-2 col-4 my-auto'>
                                        <div className=''>
                                            <img src="./technologies/perplexity.webp" alt="Digital Marketing" className="img-fluid small-image" />
                                        </div>
                                    </div>
                                    <div className='col-lg-2 col-4 my-auto'>
                                        <div className=''>
                                            <img src="./technologies/capcut.webp" alt="Digital Marketing" className="img-fluid small-image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className='mt-5 digital-tech-logo'>
                                    <div className='row justify-content-center'>
                                        ...
                                        <div className='col-lg-2 col-4 my-auto'>
                                            <div className=''>
                                                <img src="./ai-technologies/claude.webp" alt="Digital Marketing" className="img-fluid figma" />
                                            </div>
                                        </div>
                                        <div className='col-lg-2 col-4 my-auto'>
                                            <div className=''>
                                ...
                                <div className='mt-5 digital-tech-logo'>
                                    <div className='row justify-content-center'>
                                        <div className='col-lg-2 col-4 my-auto'>
                                            <div className=''>
                                                <img src="./ai-technologies/notebooklm.png" alt="Digital Marketing" className="img-fluid figma" />
                                            </div>
                                        </div>
                                        <div className='col-lg-2 col-4 my-auto'>
                                            <div className=''>
            ...
            <div className="academy-diff-closing-icon">
              <svg viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                    ...
                    <section className="academy-cta-section section-padding-bottom position-relative common-backline">
                        <div className="container">
                            <div className='row'>
                                <div className='col-lg-6'>
                                    <div>
                                ...
                                <div className='col-lg-6'>
                                    <div className="contact-form-card" data-aos="fade-up">
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <button type="submit" className='common-btn w-100 text-center'> <span>{loading ? "Submitting..." : "Submit"}</span></button >
                                        </form>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className='section-padding footer'>
                        <div className='container'>
                            <div className='row'>
                                <div className='col-lg-4'>
                                    <div>
                                        ...
                                        <p className='mb-4'>Social Sculpt Academy is the learning arm of Social Sculpt - a new-age personal branding and growth marketing agency built on creativity, consistency, and bold thinking.</p>
                            ...
                            <p className='footer-copy'>© 2025 Social Sculpt Private Limited. All rights reserved.</p>
                        </div>
                    </section>
